...
detects that subject, runs `make release-preflight VERSION=v0.1.0`, creates an
annotated git tag, and creates a GitHub Release without binary or Docker
artifacts. Release notes are generated by GitHub and grouped by
`.github/release.yml`.
